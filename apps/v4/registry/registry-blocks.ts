...
export const blocks: Registry["items"] = [
  ...
  },
  {
    ...
    dependencies: [
      "@@/registry/new-york-v4/ui/editor/hooks/use-is-touch-device",
      "@@/registry/new-york-v4/ui/editor/hooks/use-upload-file",
      "@ai-sdk/react",
      "@ariakit/react",
      "@emoji-mart/data",
      "@faker-js/faker",
    ...
    registryDependencies: [
      ...
      "link-toolbar",
      "media-audio-node",
      "media-audio-node-static",
      "media-embed-node",
      "media-file-node",
      "media-file-node-static",
      "media-image-node",
      "media-image-node-static",
      "media-placeholder-node",
      "media-preview-dialog",
      "media-upload-toast",
      "media-video-node",
      "media-video-node-static",
      "mention-node",
      "mention-node-static",
      "paragraph-node",
      "paragraph-node-static",
      "popover",
      "separator",
      "slash-node",
      "suggestion-kit",
      "suggestion-node",
      "suggestion-node-static",
      "table-node",
      "table-node-static",
      "toc-node",
      "toc-node-static",
